...
export async function getAiRecommendations({
  userId,
}: RecommendationParams): Promise<RecommendedArticle> {
  ...
  const mockArticle: RecommendedArticle = {
    ...
    image:
      "https://imgs.search.brave.com/s0ctBaElRT1W3tocaT2hjiMlNKBNOumHwMrHGQtzKoY/rs:fit:500:0:1:0/g:ce/aHR0cHM6Ly9zdDMu/ZGVwb3NpdHBob3Rv/cy5jb20vOTg4MDgw/MC8xNjM3MS9pLzQ1/MC9kZXBvc2l0cGhv/dG9zXzE2MzcxMjM4/Ni1zdG9jay1waG90/by1zY2hvb2xjaGls/ZHJlbi5qcGc",
  };
